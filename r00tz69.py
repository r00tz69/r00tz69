...
_______ \   _  \  \   _  \ _/  |_ ________ /  _____//   __   \ 
\_  __ \/  /_\  \ /  /_\  \\   __\\___   //   __  \ \____    / 
 |  | \/\  \_/   \\  \_/   \|  |   /    / \  |__\  \   /    /  
 |__|    \_____  / \_____  /|__|  /_____ \ \_____  /  /____/   
               \/        \/             \/       \/            
                                                               
    
    Servis: {}           {}by {}@r00tz69\n  
    """.format(Fore.LIGHTBLUE_EX, len(servisler_sms), Style.RESET_ALL, Fore.LIGHTRED_EX))
    try:
        menu = (input(Fore.LIGHTRED_EX + " 1- Yavaş Yavaş gondikle\n\n 2- Çok Hızlı Sms\n\n 3- Çıkış\n\n" + Fore.LIGHTRED_EX + " Seçim: "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
    ...
    if menu == 1:
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "Telefon numarasını başında '+90' olmadan yazınız (Birden çoksa 'enter' tuşuna basınız): "+ Fore.LIGHTRED_EX, end="")
        tel_no = input()
        tel_liste = []
        if tel_no == "":
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "Telefon numaralarının kayıtlı olduğu dosyanın dizinini yazınız: "+ Fore.LIGHTRED_EX, end="")
            dizin = input()
            try:
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTRED_EX + "Mail adresi (Bilmiyorsanız 'enter' tuşuna basın): "+ Fore.LIGHTRED_EX, end="")
            mail = input()
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTRED_EX + f"Kaç adet SMS göndermek istiyorsun {sonsuz}: "+ Fore.LIGHTRED_EX, end="")
            kere = input()
            if kere:
                kere = int(kere)
            else:
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTRED_EX + "Kaç saniye aralıkla göndermek istiyorsun: "+ Fore.LIGHTRED_EX, end="")
            aralik = int(input())
        except ValueError:
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "Hatalı giriş yaptın. Tekrar deneyiniz.") 
        ...
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "Telefon numarasını başında '+90' olmadan yazınız: "+ Fore.LIGHTRED_EX, end="")
        tel_no = input()
        try:
            int(tel_no)
            if len(tel_no) != 10:
